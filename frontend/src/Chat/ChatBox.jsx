...
const ChatBox = (props) => {
  ...
  const reloadMessages = () => {
    if (props.scope === "Global Chat") {
      ...
      getConversationMessages(props.user.id).then((res) => setMessages(res));
    } else {
      setMessages([]);
    }
  };
  ...
  const handleSubmit = (e) => {
    ...
    if (props.scope === "Global Chat") {
      ...
      sendConversationMessage(props.user.id, newMessage).then((res) => {
        setNewMessage("");
      });
    }
  };
                ...
                {!!messages.length && messages.map((m) => (
                  ...
                  >
                    <ListItemText
                      ...
                      primary={m.fromUser && m.fromUser.name}
